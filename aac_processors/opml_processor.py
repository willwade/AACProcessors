...
class OPMLProcessor(FileProcessor):
    ...
    def save_from_tree(self, tree: AACTree, output_path: str) -> None:
        ...
        if root_button.type != ButtonType.NAVIGATE or not root_button.target_page_id:
            self._debug_print("First button on super root page is not a navigation button")
            return
        ...
        def process_page_buttons(page, parent_element):
            ...
            for button in page.buttons:
                ...
                if button.type == ButtonType.NAVIGATE and button.target_page_id in tree.pages:
    ...
    def _extract_texts_from_element(self, element: ET.Element, texts: list[str]) -> None:
