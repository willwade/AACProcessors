...
def test_gridset_workflow(test_gridset, temp_dir):
    ...
    try:
        ...
        output_path = os.path.join(work_dir, f"{os.path.splitext(os.path.basename(test_file))[0]}_es.gridset")
        ...
        assert processor.check_is_archive(output_path), "Output file is not a valid archive"
